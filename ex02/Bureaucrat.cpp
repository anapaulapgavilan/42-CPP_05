...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/02 09:30:33 by ana-pper          #+#    #+#             */
/*   Updated: 2025/09/02 12:05:29 by ana-pper         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm& form)
{
    ...
    {
        form.beSigned(*this);
        std::cout << this->getName() << " signed " << form.getName() << std::endl; // opcional: tu mensaje “successfully signed” también vale
    }
